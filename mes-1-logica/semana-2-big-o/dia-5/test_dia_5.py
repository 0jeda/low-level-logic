...
TEST_CASES = {
    56: [
        ("5\n1 2 3 4 5\n3\n", ["MAX_SUMA=12"], "Ventana de tamaño 3 en 1..5"),
        ("6\n-2 5 -1 3 -8 4\n3\n", ["MAX_SUMA=7"], "Ventana con números negativos y positivos"),
        ("3\n10 -20 30\n1\n", ["MAX_SUMA=30"], "Ventana de tamaño 1"),
    ],
    57: [
        ("6\n2 3 1 2 4 3\n7\n", ["MIN_LONGITUD=2"], "Subarreglo mínimo de suma >= 7 (4, 3)"),
        ("3\n1 4 4\n4\n", ["MIN_LONGITUD=1"], "Subarreglo de longitud 1 ya cumple"),
        ("5\n1 2 3 4 5\n99\n", ["MIN_LONGITUD=0"], "Ningún subarreglo suma >= 99"),
    ],
    58: [
        ("5\n1 2 3 4 5\n3\n0 2\n1 3\n2 4\n", ["SUMA=6", "SUMA=9", "SUMA=12"], "Tres consultas en rango"),
        ("4\n10 -5 15 -20\n2\n0 3\n1 2\n", ["SUMA=0", "SUMA=10"], "Consultas con números negativos"),
    ],
    59: [
        ("5\n4 2 -3 1 6\n", ["SUMA_CERO=SI"], "Subarreglo 2 + -3 + 1 = 0"),
        ("3\n1 2 3\n", ["SUMA_CERO=NO"], "Arreglo con todos positivos (imposible sumar 0)"),
        ("4\n0 10 20 30\n", ["SUMA_CERO=SI"], "Contiene un cero individual"),
        ("4\n1 -1 2 -2\n", ["SUMA_CERO=SI"], "Varios subarreglos suman 0"),
    ],
    60: [
        ("8\n-2 1 -3 4 -1 2 1 -5\n", ["MAX_KADANE=6"], "Subarreglo máximo (4, -1, 2, 1)"),
        ("5\n5 4 -1 7 8\n", ["MAX_KADANE=23"], "Casi todos positivos"),
        ("4\n-1 -2 -3 -4\n", ["MAX_KADANE=-1"], "Todos negativos (retorna el menos negativo)"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 5 de la Semana 2.")
        sys.exit(1)
