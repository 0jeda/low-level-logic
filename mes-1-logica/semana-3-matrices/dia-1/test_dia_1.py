...
TEST_CASES = {
    71: [
        ("2 3\n1 2 3\n4 5 6\n", ["FILAS=6 15", "COLUMNAS=5 7 9"], "Matriz 2x3 básica"),
        ("1 1\n42\n", ["FILAS=42", "COLUMNAS=42"], "Matriz 1x1"),
    ],
    72: [
        ("2 3\n1 2 3\n4 5 6\n1 1\n", ["INDICE1D=4", "VALOR=5"], "Coordenada en rango (1, 1)"),
        ("3 3\n1 2 3\n4 5 6\n7 8 9\n2 0\n", ["INDICE1D=6", "VALOR=7"], "Coordenada en rango (2, 0)"),
        ("2 2\n1 2\n3 4\n2 0\n", ["ERROR"], "Fila fuera de rango"),
        ("2 2\n1 2\n3 4\n0 -1\n", ["ERROR"], "Columna negativa"),
    ],
    73: [
        ("2 3\n1 2 3\n4 5 6\n", ["TRANSPUESTA=", "1 4", "2 5", "3 6"], "Transpuesta 2x3 -> 3x2"),
        ("1 1\n42\n", ["TRANSPUESTA=", "42"], "Transpuesta 1x1"),
    ],
    74: [
        ("2 3\n1 5 2\n6 -3 4\n", ["MAX=6 EN (1,0)", "MIN=-3 EN (1,1)"], "Máximo y mínimo normales"),
        ("2 2\n5 5\n5 5\n", ["MAX=5 EN (0,0)", "MIN=5 EN (0,0)"], "Todos elementos iguales (elegir el primero)"),
    ],
    75: [
        ("3\n1 7 3\n7 4 -5\n3 -5 6\n", ["SIMETRICA=SI"], "Matriz simétrica 3x3"),
        ("3\n1 7 3\n7 4 -5\n3 5 6\n", ["SIMETRICA=NO"], "Matriz asimétrica (5 vs -5)"),
        ("1\n42\n", ["SIMETRICA=SI"], "Caso mínimo 1x1"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 1 de la Semana 3.")
        sys.exit(1)
