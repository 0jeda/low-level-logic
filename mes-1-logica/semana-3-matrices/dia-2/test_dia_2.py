...
TEST_CASES = {
    76: [
        ("3\n1 2 3\n4 5 6\n7 8 9\n", ["PRINCIPAL=15", "SECUNDARIA=15", "IGUALES=SI"], "Matriz 3x3 simétrica en sumas"),
        ("2\n1 2\n3 4\n", ["PRINCIPAL=5", "SECUNDARIA=5", "IGUALES=SI"], "Matriz 2x2"),
        ("3\n1 2 3\n4 5 6\n7 8 10\n", ["PRINCIPAL=16", "SECUNDARIA=15", "IGUALES=NO"], "Matriz 3x3 asimétrica en sumas"),
    ],
    77: [
        ("3 3\n1 2 3\n4 5 6\n7 8 9\n", ["ESPIRAL=1 2 3 6 9 8 7 4 5"], "Espiral en 3x3"),
        ("2 4\n1 2 3 4\n5 6 7 8\n", ["ESPIRAL=1 2 3 4 8 7 6 5"], "Espiral rectangular 2x4"),
    ],
    78: [
        ("3\n1 2 3\n4 5 6\n7 8 9\n", ["ROTADA=", "7 4 1", "8 5 2", "9 6 3"], "Rotación 90 grados 3x3"),
        ("2\n1 2\n3 4\n", ["ROTADA=", "3 1", "4 2"], "Rotación 90 grados 2x2"),
    ],
    79: [
        ("3\n1 0 0\n0 1 0\n0 0 1\n", ["IDENTIDAD=SI"], "Identidad 3x3 válida"),
        ("2\n1 2\n0 1\n", ["IDENTIDAD=NO"], "Falso por celda no-diagonal distinta de cero"),
        ("3\n1 0 0\n0 0 0\n0 0 1\n", ["IDENTIDAD=NO"], "Falso por cero en diagonal"),
    ],
    80: [
        ("2 3\n1 2 3\n4 5 6\n", ["ESPEJO=", "3 2 1", "6 5 4"], "Espejo horizontal 2x3"),
        ("3 2\n10 20\n30 40\n50 60\n", ["ESPEJO=", "20 10", "40 30", "60 50"], "Espejo horizontal 3x2"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 2 de la Semana 3.")
        sys.exit(1)
