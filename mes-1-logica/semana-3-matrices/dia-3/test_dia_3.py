...
TEST_CASES = {
    81: [
        ("4\n4 3 2 1\n", ["INTERCAMBIOS=6", "ORDENADO=1 2 3 4"], "Matriz invertida (máximos intercambios)"),
        ("3\n1 2 3\n", ["INTERCAMBIOS=0", "ORDENADO=1 2 3"], "Matriz ya ordenada (0 intercambios)"),
        ("5\n5 1 4 2 8\n", ["INTERCAMBIOS=4", "ORDENADO=1 2 4 5 8"], "Desordenado normal"),
    ],
    82: [
        ("3\n1 2 3\n", ["PASADAS=1", "ORDENADO=1 2 3"], "Ya ordenado (termina en 1 pasada)"),
        ("4\n4 3 2 1\n", ["PASADAS=3", "ORDENADO=1 2 3 4"], "Invertido completo (corre todas las pasadas)"),
        ("5\n5 1 4 2 8\n", ["PASADAS=3", "ORDENADO=1 2 4 5 8"], "Termina temprano en la pasada 3"),
    ],
    83: [
        ("4\n1 2 3 4\n", ["ORDENADO=4 3 2 1"], "Ascendente -> Descendente"),
        ("5\n5 1 4 2 8\n", ["ORDENADO=8 5 4 2 1"], "Desordenado -> Descendente"),
    ],
    84: [
        ("4\n4 3 2 1\n", ["ORDENADO=1 2 3 4"], "Invertido completo con Cocktail Shaker"),
        ("5\n5 1 4 2 8\n", ["ORDENADO=1 2 4 5 8"], "Desordenado con Cocktail Shaker"),
    ],
    85: [
        ("5\n5 1 4 2 8\n2\n", ["ELEMENTO=2"], "2do elemento menor en [1, 2, 4, 5, 8]"),
        ("4\n10 -5 20 0\n1\n", ["ELEMENTO=-5"], "1er elemento menor"),
        ("4\n10 -5 20 0\n4\n", ["ELEMENTO=20"], "4to elemento menor (el máximo)"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 3 de la Semana 3.")
        sys.exit(1)
