...
TEST_CASES = {
    96: [
        ("2 3\n5 1 6\n3 4 2\n", ["MATRIZ=", "1 2 3", "4 5 6"], "Ordenar matriz completa 2x3"),
        ("2 2\n4 3\n2 1\n", ["MATRIZ=", "1 2", "3 4"], "Ordenar matriz 2x2 invertida"),
    ],
    97: [
        ("2 3\n5 1 6\n3 4 2\n", ["MATRIZ=", "1 5 6", "2 3 4"], "Ordenar filas de forma independiente"),
        ("2 2\n1 2\n3 4\n", ["MATRIZ=", "1 2", "3 4"], "Matriz ya ordenada"),
    ],
    98: [
        ("3 2\n5 4\n1 6\n3 2\n", ["MATRIZ=", "1 2", "3 4", "5 6"], "Ordenar columnas de forma independiente"),
        ("2 2\n1 2\n3 4\n", ["MATRIZ=", "1 2", "3 4"], "Columnas ya ordenadas"),
    ],
    99: [
        ("3\n9 2 3\n4 5 6\n7 8 1\n", ["MATRIZ=", "1 2 3", "4 5 6", "7 8 9"], "Diagonal principal 9,5,1 -> 1,5,9"),
        ("2\n4 2\n3 1\n", ["MATRIZ=", "1 2", "3 4"], "Diagonal 4,1 -> 1,4"),
    ],
    100: [
        ("2 3\n1 2 3\n4 5 6\n5\n", ["POSICION=(1,1)"], "Búsqueda de 5 en matriz ordenada"),
        ("2 3\n1 2 3\n4 5 6\n9\n", ["ERROR"], "Búsqueda de ausente"),
        ("2 2\n10 20\n30 40\n10\n", ["POSICION=(0,0)"], "Búsqueda en esquina superior izquierda"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 6 de la Semana 3.")
        sys.exit(1)
