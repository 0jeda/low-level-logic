...
TEST_CASES = {
    116: [
        ("5\n1 2 3 4 5\n", ["SUMA=15"], "Suma de 1 a 5"),
        ("3\n-10 0 10\n", ["SUMA=0"], "Suma con negativos y cero"),
    ],
    117: [
        ("4\n1 2 3 4\n5\n", ["ARR=[5,10,15,20]"], "Escalar por 5"),
        ("2\n-3 7\n-2\n", ["ARR=[6,-14]"], "Escalar por -2"),
    ],
    118: [
        ("5\n10 20 30 40 50\n", ["DESTINO=[10,20,30,40,50]"], "Copia de arreglo de 5 elementos"),
        ("1\n-99\n", ["DESTINO=[-99]"], "Copia de un solo elemento"),
    ],
    119: [
        ("5\n1 2 3 2 1\n2\n", ["INDICE=1"], "Búsqueda de 2 (primer índice)"),
        ("4\n10 20 30 40\n50\n", ["INDICE=-1"], "Búsqueda de elemento no existente"),
    ],
    120: [
        ("5\n1 2 3 4 5\n", ["INVERTIDO=[5,4,3,2,1]"], "Inversión impar"),
        ("4\n10 20 30 40\n", ["INVERTIDO=[40,30,20,10]"], "Inversión par"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 3 de la Semana 4.")
        sys.exit(1)
