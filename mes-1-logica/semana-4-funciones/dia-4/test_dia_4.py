...
TEST_CASES = {
    121: [
        ("2 3\n1 2 3\n4 5 6\n", ["SUMA=21"], "Suma de matriz 2x3"),
        ("1 1\n-5\n", ["SUMA=-5"], "Suma de matriz 1x1 con negativo"),
    ],
    122: [
        ("2 3\n1 2 3\n4 5 6\n", ["FILA_0=[1,2,3]", "FILA_1=[4,5,6]"], "Impresión de matriz 2x3"),
        ("3 2\n10 20\n30 40\n50 60\n", ["FILA_0=[10,20]", "FILA_1=[30,40]", "FILA_2=[50,60]"], "Impresión de matriz 3x2"),
    ],
    123: [
        ("2 3\n1 2 3\n4 5 6\n", ["FILA_0=[1,4]", "FILA_1=[2,5]", "FILA_2=[3,6]"], "Transpuesta de 2x3 a 3x2"),
        ("2 2\n9 8\n7 6\n", ["FILA_0=[9,7]", "FILA_1=[8,6]"], "Transpuesta de 2x2 cuadrada"),
    ],
    124: [
        ("2 2\n1 2\n3 4\n5 6\n7 8\n", ["FILA_0=[6,8]", "FILA_1=[10,12]"], "Suma de matrices 2x2"),
        ("1 3\n1 -1 0\n2 2 2\n", ["FILA_0=[3,1,2]"], "Suma de matrices 1x3"),
    ],
    125: [
        ("2 3\n10 20 30\n40 50 60\n", ["FILA_0=[10,20,30]", "FILA_1=[40,50,60]"], "Copia de matriz 2x3"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 4 de la Semana 4.")
        sys.exit(1)
