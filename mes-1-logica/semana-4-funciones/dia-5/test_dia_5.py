...
TEST_CASES = {
    126: [
        ("7\n", ["PRIMO=1"], "7 es primo"),
        ("4\n", ["PRIMO=0"], "4 no es primo"),
        ("1\n", ["PRIMO=0"], "1 no es primo"),
    ],
    127: [
        ("5\n", ["FACTORIAL=120"], "Factorial de 5"),
        ("0\n", ["FACTORIAL=1"], "Factorial de 0"),
    ],
    128: [
        ("2 10\n", ["POTENCIA=1024"], "2 elevado a la 10"),
        ("5 0\n", ["POTENCIA=1"], "5 elevado a la 0"),
        ("-3 3\n", ["POTENCIA=-27"], "-3 elevado a la 3"),
    ],
    129: [
        ("5\n1 2 3 4 5\n", ["PARES=[2,4]"], "Filtrado de pares normales"),
        ("4\n1 3 5 7\n", ["PARES=[]"], "Filtrado de pares con ningún par"),
    ],
    130: [
        ("Hola Mundo\n", ["CONCATENADO=HolaMundo"], "Concatenación de Hola y Mundo"),
        ("Prog C++\n", ["CONCATENADO=ProgC++"], "Concatenación de Prog y C++"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 5 de la Semana 4.")
        sys.exit(1)
