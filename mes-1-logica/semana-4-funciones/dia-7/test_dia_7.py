...
TEST_CASES = {
    ...
    137: [
        ("2 2\n5 6\n7 8\n1 2\n3 4\n", ["FILA_0=[4,4]", "FILA_1=[4,4]"], "Resta de matrices 2x2"),
    ],
    138: [
        ("2 3\n1 2 3\n4 5 6\n3 2\n7 8\n9 10\n11 12\n", ["FILA_0=[58,64]", "FILA_1=[139,154]"], "Multiplicación 2x3 por 3x2"),
    ],
    139: [
        ("3\n1 2 3\n4 5 6\n7 8 9\n", ["TRAZA=15"], "Traza de matriz 3x3 (1+5+9)"),
    ],
    140: [
        ("+\n2 2\n1 2\n3 4\n5 6\n7 8\n", ["FILA_0=[6,8]", "FILA_1=[10,12]"], "Suma integradora"),
        ("*\n2 3\n1 2 3\n4 5 6\n3 2\n7 8\n9 10\n11 12\n", ["FILA_0=[58,64]", "FILA_1=[139,154]"], "Multiplicación integradora"),
        ("*\n2 3\n1 2 3\n4 5 6\n2 2\n1 2\n3 4\n", ["ERROR_DIMENSION"], "Multiplicación con error de dimensión"),
        ("T\n3\n1 2 3\n4 5 6\n7 8 9\n", ["TRAZA=15"], "Traza integradora"),
    ]
}
...
def main():
    ...
    if reto_num not in TEST_CASES:
        print(f"❌ Reto {reto_num} inválido para el Día 7 de la Semana 4.")
        sys.exit(1)
